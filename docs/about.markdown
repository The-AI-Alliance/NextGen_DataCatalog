...
# About Next Generation OTDI Data Catalog and The AI Alliance

**Next Generation OTDI Data Catalog** is a project of the [Foundation Models and Datasets](https://thealliance.ai/focus-areas/foundation-models){:target="wg"} work group in [The AI Alliance](https://thealliance.ai){:target="ai-alliance"}. 
